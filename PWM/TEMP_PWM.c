...
void pwm_init(pwm_var *pwm_var) {
    ...
    SCT0->EV[2].CTRL  = (1 << 0) | (1 << 12);

    SCT0->EV[3].STATE = 0xFFFFFFFF; 
    SCT0->EV[3].CTRL  = (1 << 0) | (1 << 12);

    SCT0->EV[4].STATE = 0xFFFFFFFF; 
    SCT0->EV[4].CTRL  = (1 << 0) | (1 << 12);

    SCT0->EV[5].STATE = 0xFFFFFFFF; 
    SCT0->EV[5].CTRL  = (1 << 0) | (1 << 12);

    SCT0->EV[5].STATE = 0xFFFFFFFF; 
    SCT0->EV[5].CTRL  = (1 << 0) | (1 << 12);

    SCT0->EV[6].STATE = 0xFFFFFFFF; 
    SCT0->EV[6].CTRL  = (1 << 0) | (1 << 12);
...
void PWM_convert_1(uint32_t freq, uint32_t duty_p){
